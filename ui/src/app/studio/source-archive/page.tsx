...
export default async function StudioSourceArchivePage() {
  await ensureKnowledgePipelineSeeds();
  const [items, stats, aiSession] = await Promise.all([
    listKnowledgeHub(80),
    getKnowledgeHubStats(),
    loadAiReviewSession("KNOWLEDGE_SOURCE", null),
  ]);
    ...
    <>
      ...
      <StudioPageBody>
        ...
        <EntityAiReviewMini
          ...
          session={aiSession}
          label="Source title or URL (for AI duplicate check)"
        />
